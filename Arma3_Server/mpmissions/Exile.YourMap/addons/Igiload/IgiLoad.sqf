...
if (_obj_main_type in IL_Supported_Vehicles_URAL_COVERED) then
{
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">Load cargo on URAL</t>",
    {
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">Load vehicle on URAL</t>",
    {
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ffff00"">Unload cargo from URAL</t>",
    {
        [_this select 0] call IL_Do_Unload;
    },[],IL_Action_O_Priority,false,true,"",
    "(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_V3S) then
{
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">Load cargo on V3S</t>",
    {
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">Load vehicle on V3S</t>",
    {
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">Unload cargo from V3S</t>",
    {
        [_this select 0] call IL_Do_Unload;
    },[],IL_Action_LU_Priority,false,true,"",
    "(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_BLACKFISH) then
{
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">Load cargo on Blackfish</t>",
    {
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">Load vehicle on Blackfish</t>",
    {
    ...
    _obj_main addAction [
    "<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">Unload cargo from Blackfish</t>",
    {
        [_this select 0] call IL_Do_Unload;
    },[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_Y32) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">Load cargo in Y-32 Xian</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">Load vehicle in Y-32 Xi'an</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">Unload cargo from Y-32 Xian</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-6.5,-2.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed) && (((getPos _target) select 2) <= IL_LU_Alt) && (_target doorPhase 'Door_1_source' == 1)"
...
if (_obj_main_type in IL_Supported_Vehicles_HURON) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">Load cargo in CH-67 Huron</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">Load vehicle in CH-67 Huron</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">Unload cargo from CH-67 Huron</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_HUNTER) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">Load cargo on HUNTER</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ffff00"">Unload cargo from HUNTER</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_IFRIT) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">Load cargo on IFRIT</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ffff00"">Unload cargo from IFRIT</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_STRIDER) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">Load cargo on STRIDER</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ffff00"">Unload cargo from STRIDER</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_LANDROVER) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">  Load cargo on LANDROVER</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">  Load vehicle on LANDROVER</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ffff00"">  Unload cargo from LANDROVER</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_AMBULANCE) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">  Load cargo on AMBULANCE</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#ffff00"">  Load vehicle on AMBULANCE</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ffff00"">  Unload cargo from AMBULANCE</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
