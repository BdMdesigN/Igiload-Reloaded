...
cutText ["IgiLoad - Reloaded is loading. Please wait...","PLAIN",2];
sleep (random 30);

cutText [Format ["IgiLoad - Reloaded init Player: %1", Player],"PLAIN",2];
...
cutText ["IgiLoad - Reloaded loaded. Have fun :)","PLAIN",2];
